...
@SuppressWarnings("unused") // autogenerated stuff. 
public class FoxieModel extends EntityModel<Foxie> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition
			.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 2).addBox(-3.0F, -3.0F, -5.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 14.1F, -1.7F));
	...
	public void setupAnim(Foxie foxie, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (foxie.aiControl.isSleeping()) this.body.y = 20.0F;
		else if (foxie.aiControl.isSitting()) this.body.y = 16.5F;
		else this.body.y = 14.1F;
	}
	...
	public void setRotateAngleDeg(
		ModelPart renderer, float x, float y, float z) {
		this.setRotateAngle(renderer, rad(x), rad(y), rad(z));
	}
}
