...
public class EntityTypeTagsProvider extends TagsProvider<EntityType<?>> {
    ...
    public EntityTypeTagsProvider(DataGenerator generator, @Nullable ExistingFileHelper helper) {
        //noinspection deprecation
        super(generator, Registry.ENTITY_TYPE, FoxieMCMod.ID, helper);
    }

    protected void addTags() {
        this.tag(EntityTypeTags.POWDER_SNOW_WALKABLE_MOBS).add(EntityInit.FOXIE.get());
        this.tag(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES).add(EntityInit.FOXIE.get());
    }
